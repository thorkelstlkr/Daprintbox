...
(function () {
  ...
  function viewSettings() {
    ...
    return `
      ...
      ${remote ? `<div class="card">
        ...
        <p class="small muted" style="margin-bottom:0"><a href="privacidad.html" target="_blank" rel="noopener">Política de privacidad</a> · Para borrar tu cuenta, escribe al administrador indicando tu usuario.</p>
      </div>` : ''}
  ...
  async function showLogin(message, mode = 'login') {
    ...
    view.innerHTML = `<div class="card login">
      ...
      <p class="small muted login-legal">${registering ? 'Al crear la cuenta aceptas la' : 'Consulta la'} <a href="privacidad.html" target="_blank" rel="noopener">política de privacidad</a>.</p>
    </div>`;
